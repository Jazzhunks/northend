...
/**
 * Reusable file upload that posts to /api/upload and calls onUploaded({id, url, original_filename}).
 * accept: comma-separated list of mime types (default: pdf + images)
 */
export default function FileUpload({ label = "Upload file", accept = "application/pdf,image/jpeg,image/png,image/webp", onUploaded, value, testId = "file-upload" }) {
  ...
  const clear = () => { setInfo(null); onUploaded?.(null); };
