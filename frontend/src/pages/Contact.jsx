...
export default function Contact() {
  ...
  const inputCls = "w-full px-4 py-3 rounded-xl glass text-sm text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:border-accent/50 invalid:border-destructive transition";
              ...
              <GlassPanel elevated className="p-7" as="form" onSubmit={submit}>
                <div className="space-y-3">
                  <div className="grid sm:grid-cols-2 gap-3">
                    ...
                    <input className={inputCls} placeholder="Phone" value={f.phone} onChange={e=>setF({...f, phone: e.target.value})} required data-testid="contact-phone"/>
