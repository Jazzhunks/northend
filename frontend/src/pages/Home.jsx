      ...
      <div data-testid="home-page">
        ...
        <section className="relative min-h-screen flex items-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 lg:px-8 w-full grid lg:grid-cols-12 gap-8 items-center py-12 lg:py-24">
            <div className="lg:col-span-7">
              ...
              <motion.h1
                ...
                className="font-display text-5xl sm:text-6xl lg:text-7xl font-light tracking-[-0.04em] leading-[0.95] text-foreground"
              >
                The future of<br/>
          ...
          <motion.div
            ...
            className="absolute bottom-6 left-1/2 -translate-x-1/2 z-10 text-[10px] uppercase tracking-[0.3em] text-muted-foreground hidden sm:block pointer-events-none select-none"
          >
            Scroll to explore ↓
          </motion.div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-8 relative">
            <div className="grid lg:grid-cols-12 gap-8 mb-14">
              <div className="lg:col-span-7">
                ...
                <Reveal>
                  <h2 className="font-display text-4xl lg:text-5xl font-light tracking-tight leading-[1.02] mt-4">
              ...
              <GlassPanel elevated className="relative overflow-hidden p-10 lg:p-16">
                ...
                <div className="relative grid lg:grid-cols-2 gap-10 items-center">
                  <div>
                    ...
                    <h2 className="font-display text-4xl lg:text-5xl font-light tracking-tight mt-4 leading-[1.05]">
...
// Fixed: Isolated function block compiled safely outside the main Home render scope 
