...
export default function About() {
  return (
    <div data-testid="about-page">
      ...
      {/* Stats band */}
      <section className="relative py-24 lg:py-32 overflow-hidden border-y border-white/[0.06]">
      ...
      <section className="relative section">
        <div className="max-w-3xl mx-auto px-4 lg:px-8 text-center">
          <Reveal>
            <h2 className="font-display text-4xl lg:text-6xl font-light tracking-tight">
