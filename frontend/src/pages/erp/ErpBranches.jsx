  ...
  return (
    <div className="space-y-8 animate-fadeIn" data-testid="erp-branches-page">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        {items.map(b => (
          <div key={b.id} className="glass-elevated rounded-2xl p-6 border border-white/5 relative overflow-hidden group hover:border-accent/20 transition-all duration-300" data-testid={`branch-card-${b.id}`}>
          ...
          >
            <div className="flex justify-between items-start">
              ...
              <button 
                ...
                className="p-1 hover:bg-white/5 rounded-lg border border-transparent hover:border-white/10 transition"
              >
                <X size={18}/>
              </button>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-3 py-2 border border-white/10 bg-background/50 rounded-xl text-sm font-mono text-foreground placeholder:text-muted-foreground/30 focus:outline-none focus:border-accent/50" 
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full px-3 py-2 border border-white/10 bg-background/50 rounded-xl text-sm text-foreground focus:outline-none focus:border-accent/50" 
