...
// Static fallback records to guarantee search engines parse structural microdata instantly
...
export default function Courses() {
  ...
  // Use network data if loaded, otherwise fall back to static indicators for the crawlers
  ...
  return (
    <>
      <Helmet>
        ...
        {/* Dynamic-fallback Hybrid ItemList Schema matrix container */}
